...
// Error definitions
var (
	AVERROR_BSF_NOT_FOUND      = Error{C.AVERROR_BSF_NOT_FOUND}
	AVERROR_BUFFER_TOO_SMALL   = Error{C.AVERROR_BUFFER_TOO_SMALL}
	AVERROR_BUG                = Error{C.AVERROR_BUG}
	AVERROR_BUG2               = Error{C.AVERROR_BUG2}
	AVERROR_DECODER_NOT_FOUND  = Error{C.AVERROR_DECODER_NOT_FOUND}
	AVERROR_DEMUXER_NOT_FOUND  = Error{C.AVERROR_DEMUXER_NOT_FOUND}
	AVERROR_ENCODER_NOT_FOUND  = Error{C.AVERROR_ENCODER_NOT_FOUND}
	AVERROR_EOF                = Error{C.AVERROR_EOF}
	AVERROR_EXIT               = Error{C.AVERROR_EXIT}
	AVERROR_EXPERIMENTAL       = Error{C.AVERROR_EXPERIMENTAL}
	AVERROR_EXTERNAL           = Error{C.AVERROR_EXTERNAL}
	AVERROR_FILTER_NOT_FOUND   = Error{C.AVERROR_FILTER_NOT_FOUND}
	AVERROR_INPUT_CHANGED      = Error{C.AVERROR_INPUT_CHANGED}
	AVERROR_INVALIDDATA        = Error{C.AVERROR_INVALIDDATA}
	AVERROR_MUXER_NOT_FOUND    = Error{C.AVERROR_MUXER_NOT_FOUND}
	AVERROR_OPTION_NOT_FOUND   = Error{C.AVERROR_OPTION_NOT_FOUND}
	AVERROR_OUTPUT_CHANGED     = Error{C.AVERROR_OUTPUT_CHANGED}
	AVERROR_PATCHWELCOME       = Error{C.AVERROR_PATCHWELCOME}
	AVERROR_PROTOCOL_NOT_FOUND = Error{C.AVERROR_PROTOCOL_NOT_FOUND}
	AVERROR_STREAM_NOT_FOUND   = Error{C.AVERROR_STREAM_NOT_FOUND}
	AVERROR_UNKNOWN            = Error{C.AVERROR_UNKNOWN}
)
